...
entity FootballPlayers {
    key PlayerID   : Integer @title: '선수 ID';
        PlayerName : String  @title: '선수 이름';
        Age        : Integer @title: '나이';
        Position   : String  @title: '포지션';
        Team       : String  @title: '팀';
        Country    : String  @title: '국가';
}